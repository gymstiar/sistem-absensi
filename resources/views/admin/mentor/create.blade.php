...
<head>
    ...
    <title>Tambah Mentor - Sistem Absensi</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 ms-sm-auto content">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Tambah Mentor</h1>
                </div>

                <form method="POST" action="/admin/mentor">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <a href="/admin/mentor" class="btn btn-secondary">Kembali</a>
                </form>
            </div>
        </div>
    </div>
